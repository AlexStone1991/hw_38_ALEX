...
from core.views import landing, thanks, orders_list, order_detail, about, services_list, create_order, create_review, master_services_api, master_detail, service_masters_api
...
urlpatterns = [
    ...
    path('api/service/<int:service_id>/masters/', service_masters_api),
