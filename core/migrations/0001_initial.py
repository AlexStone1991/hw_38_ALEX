    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('new', 'Новый'), ('confirmed', 'Подтвержден'), ('completed', 'Завершена'), ('canceled', 'Отменена')], default='not_approved', max_length=50, verbose_name='Статус')),
